...
　Short系（先頭に`｜`か`↓`がない単純なルビ）の解析について。

* 親文字（漢字のみ）
    * 全体ルビ（任意で下位置指定）ShortRubyParser          あ鈴木一郎《すずきいちろう｜イチロー》い
    * 一字ルビ（任意で＋全体ルビ）                         あ鈴木一郎《すず,き,いち,ろう｜イチロー》い
...
* rt
    * pipe: `｜`: 上下群に対応する区切文字がある
    * comma: `,`: 漢字に対応する区切文字がある
    * none: `pipe`や`comma`がないが、他の字はある
    * blank: 空（字種に関わらず一文字もない）

## Long

　Long系（先頭に`｜`か`↓`がある）の解析方法について。

* 親文字
    * 漢字のみ
        * 全体ルビ（任意で下位置指定）                     山｜鈴木一郎《すずきいちろう｜イチロー》川
        * 部分ルビ（任意で＋全体ルビ）KanjiGroupRubyParser ｜鈴木｜一郎《すずき｜いちろう｜イチロー》
        * 一字ルビ（任意で＋全体ルビ）KanjiRubyParser      ｜鈴木一郎《すず,き,いち,ろう｜イチロー》
    * 不問
        * 全体ルビ（任意で下位置指定）                     ｜あいうえお《AIUEO｜アイウエオ》
        * 漢字群のみルビ（任意で＋全体ルビ）               ｜論救の御手《ろんきゅう｜みて｜ロジカル・サルベータ》
