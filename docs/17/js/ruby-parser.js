...
//            console.log(`Found ${match[0]}. Next starts at ${REGEX.RT.lastIndex}.`);
            ...
            if (null===rb) {htmls.push(match[0])} // rbなし：そのまま出力する
            else if (rb.isShort){htmls.push(match, rb)} // Short
            else {return htmls.push(match[0])} // rbなし：そのまま出力する
        }
