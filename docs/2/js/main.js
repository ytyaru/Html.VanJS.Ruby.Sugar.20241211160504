...
//    console.log(UnderShortRubyParser.parse('あ↓漢字《かんじ》い'))
    console.log(LongRubyParser.parse('あ↓漢字《かんじ》い'))
    ...
    console.log(LongRubyParser.parse('｜漢字《かんじ》'))
    console.log(LongRubyParser.parse('↓漢字《かんじ》'))
    console.log(LongRubyParser.parse('｜ああ複数の漢字にルビ一つだけ《ふくすう》'))
    // 想定外↓↓↓↓↓
    console.log(LongRubyParser.parse('｜漢字《》'))
    console.log(LongRubyParser.parse('｜漢字《》'))
    console.log(LongRubyParser.parse('｜漢字《｜》'))
    console.log(LongRubyParser.parse('｜漢字《か｜カ》'))
    console.log(LongRubyParser.parse('｜漢字《か｜》'))
    console.log(LongRubyParser.parse('｜漢字《｜カ》'))
    console.log(LongRubyParser.parse('｜漢字《か｜カ｜キ》'))
    // 想定外↑↑↑↑↑
    console.log(ShortRubyParser.parse('山《やま》田《だ》'))
    console.log(ShortRubyParser.parse('太《た》郎《ろう》'))
    console.log(ShortRubyParser.parse('山田《やまだ》太郎《たろう》'))
    console.log(ShortRubyParser.parse('山田太郎《やまだたろう》'))
//    console.log(ShortRubyParser.parse('山田太郎《やま｜だ｜た｜ろう｜やまだたろう》')) // 不可能！！！
    console.log(ShortRubyParser.parse('山田太郎《やまだたろう｜Yamada Tarou》'))
});
