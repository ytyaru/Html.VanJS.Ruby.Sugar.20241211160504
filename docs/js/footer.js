...
class Footer {
    constructor(author, prePath) {
        ...
        this._created = '2024-12-11T16:04:20+0900'
    ...
    #copyright() { return small('©', time({datetime:this._created}, '2024'), this.#author()) }
    ...
    #project() { return a(this.#externalLinkAttr(({href:`https://github.com/${this._author}/Ruby.Sugar/`})), img({class:'icon', src:`${this._prePath}asset/image/logo/github/black.svg`})) }
