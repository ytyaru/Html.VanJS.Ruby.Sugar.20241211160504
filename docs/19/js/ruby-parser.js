...
//        const before = this.#before(text.slice(oldRtEnd, newRtStart).slice(this.MAX_LEN*-1)}, rtIdx)
...
//        console.log(`before50:${before50}`)
        ...
        console.debug(`before50:${before50} ends:${ends} end:${end}`)
...
//                    kanjis:Array.from(kanjiGroups), kanjiGroups:kanjiGroups,
        ...
        for (let head of ['｜','↓','￬￬','||','|']) {
            ...
            //const rb = before.slice(li+head.length, rtIdx)
